...
if __name__ == '__main__':
    ...
    if not os.path.isfile('4class_experiments/4_layer/' + args.replace('_result', '_injected_summary')):
        output_data.to_csv('4class_experiments/4_layer/' + args.replace('_result', '_injected_summary'), index = False, header = True)
    else: # else it exists so append without writing the header
        output_data.to_csv('4class_experiments/4_layer/' + args.replace('_result', '_injected_summary'),index = False, mode = 'a', header = False)
