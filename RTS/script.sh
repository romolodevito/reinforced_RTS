...
export U_DB_DIR=/Users/romolodevito/Desktop/commons-lang
...
then
    ...
    $UND_DIR/und -db $U_DB_DIR/commons-lang.udb analyze    #faccio il rescan perchè sono stati aggiunti o eliminati dei file nel database, i file affetti saranno analizzati
    ...
    $UND_DIR/und -db $U_DB_DIR/commons-lang.udb analyze -changed  #aggiorno solo i file modificati (-changed) nel database Understand
fi
